...
class sun(datasets.imdb):
    def __init__(self, image_set, devkit_path):
        datasets.imdb.__init__(self, image_set)
        self._image_set = image_set
        self._devkit_path = devkit_path
        self._data_path = os.path.join(self._devkit_path, 'data')
        #modify line below to include different classes 
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_sun_annotation(index)
    ...
    def _load_sun_annotation(self, index):
    ...
    def _write_sun_results_file(self, all_boxes):
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        comp_id = self._write_sun_results_file(all_boxes)
